...
modelFit <- randomForest(classe ~ yaw_belt + yaw_dumbbell + total_accel_dumbbell + accel_dumbbell_z + magnet_dumbbell_x + magnet_dumbbell_y + magnet_dumbbell_z, data = training, importance = TRUE, ntree = 200)
